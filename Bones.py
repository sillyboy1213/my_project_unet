...
class Dataset(data.Dataset):
    ...
    def __getitem__(self, index):
        ...
        # 这里我的img是（H，W，3），但是是灰度图，所以先转成灰度图像
...
if __name__ == '__main__':
    ...
    # 测试加载数据类
    def demo():
        train_path = r'./media/Datasets/Bones/raw_data'
        val_path = r'./media/Datasets/Bones/raw_data'
        test_path = r'./media/Datasets/Bones/test'
